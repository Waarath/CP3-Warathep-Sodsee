...
def currency_input(event):
    usd_currency = input_us_dollar.get()
    result = math.ceil(currency.convert(usd_currency,'USD','THB'))
...
convert_button.bind('<Button-1>',currency_input)
